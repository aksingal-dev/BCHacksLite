...
public class StoryNode implements ActionListener
{
   ...
   public StoryNode ()
   {
      ...
      option4 = new JButton(costume4);
      option4.setText("hello");
